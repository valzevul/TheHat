...
class MainTutorialViewController: BaseViewController, UIPageViewControllerDataSource {
    ...
    let pageDescriptions =
        ...
        "Игроков можно добавлять из Адресной книги устройства или последовательно вводить всю информацию.",
        "Имена уже созданных игроков можно менять, равно как и удалять.",
        "Адресная книга поддерживает множественное добавление игроков и поиск по именам.",
        "Редактирование слов включает в себя добавление новых и удаление или изменение старых.",
        "В процессе игры свайп вправо по экрану обозначает успешно угаданное слово, а свайп вправо — «испорченное» (подробнее — в правилах игры).",
        "Результаты предыдущего раунда доступны перед началом следующего, а общие результаты — сразу после окончания игры.",
        "После окончания раунда можно изменить статус слов, которые в нем встретились."]
